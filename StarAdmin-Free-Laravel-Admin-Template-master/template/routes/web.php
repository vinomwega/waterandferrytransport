...
Route::get('/login', [App\Http\Controllers\Auth\LoginController::class, 'authenticate']);
Route::get('/logout', [App\Http\Controllers\Auth\LoginController::class, 'logout'])-> name('logout');

//register
Route::get('/register', [App\Http\Controllers\Auth\RegisterController::class, 'register'])-> name('register');
Route::get('/register', [App\Http\Controllers\Auth\RegisterController::class, 'customer'])-> name('register');

//forget password
Route::get('/forget-password', [App\Http\Controllers\Auth\ForgetPasswordController::class, 'getEmail'])-> name('forget-password');
Route::get('/forget-password', [App\Http\Controllers\Auth\ForgetPasswordController::class, 'postEmail'])-> name('forget-password');

//rest password
Route::get('/reset-password/{token}', [App\Http\Controllers\Auth\RestPasswordController::class, 'getPassword']);
Route::get('/rest-password', [App\Http\Controllers\Auth\RestPasswordController::class, 'updatePassword']);
